...
class HrPayslip(models.Model):
    ...
    def action_payslip_done(self):
        ...
        for slip in self:
            ...
            if slip.payslip_refunded_id and slip.adj_method and slip.adj_method == 'adjustment':
                slip.payslip_refunded_id.move_id.button_cancel()
                slip.payslip_refunded_id.move_id.line_ids = False
                slip.payslip_refunded_id.move_id.line_ids = line_ids
                move = slip.payslip_refunded_id.move_id
            else:
