...
{
    'name': 'Mass Payslip Send by Email-Odoo Community Edition',
    'version': '14.0.0.0',
    'category': 'Human Resources',
    'sequence': 11,
    'summary': 'send mass payslip for community employee send payslip mass send by email payslip mass employee payslip send by email multiple payslip send by email send payroll payslip by email send mass payroll payslip send by email community send mass payslip by email',
    'description': """
