...
{
    'name': 'Employee Advance Salary Requests Odoo Community',
    'version': '14.0.0.0',
    'category': 'Human Resources',
    'summary': 'HR Advance Salary Request Employee salary Advance Salary Request Approval Director Approval on employee Advance Salary Request Employee Payslip Advance Employee Advance Payslip Advance Salary employee Requests Advance Salary for employee Salary approval',
...
Under HR menu to request advance salary by employee (List view). Normal employee can see his/her on request.(Thanks to Security added in module) with multiple approval from the higher authority. Helps to generate a report about advance salary""",
    ...
    'depends': ['base','hr','bi_hr_payroll','account','l10n_co'],
    'data': [
            'security/groups.xml',
    ...
    'installable': True,
    'live_test_url':'https://youtu.be/WwUztn3G-hc',
    'auto_install': False,
    'application': True,
